...
- (void)documentIsReady{
    if (self.document.documentState == UIDocumentStateNormal){
        ...
        Person *person2;
        person2 = [NSEntityDescription insertNewObjectForEntityForName:@"Person" inManagedObjectContext:context];
        NSString *personsName = person2.name;
        MSLog(@"name: %@", personsName);
        ...
        NSSet *closePeople = [NSSet setWithObjects:michiel, person2, nil];
